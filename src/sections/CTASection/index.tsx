export const CTASection = () => {
  return (
    <div className="absolute text-[15.1297px] items-center box-border caret-transparent flex flex-col h-[1891.21px] justify-start tracking-[-0.302594px] leading-[21.1816px] mix-blend-difference text-center z-[6] inset-[0%] md:text-[15.2873px] md:h-[2500px] md:tracking-[-0.305746px] md:leading-[21.4022px] md:z-auto">
      <div className="sticky text-[15.1297px] items-center box-border caret-transparent flex flex-col h-[756.485px] justify-center tracking-[-0.302594px] leading-[21.1816px] z-[9] overflow-hidden top-0 md:text-[15.2873px] md:h-[1000px] md:tracking-[-0.305746px] md:leading-[21.4022px] md:z-auto">
        <a
          href="https://www.creativegiants.art/contact"
          className="text-[15.1297px] box-border caret-transparent block tracking-[-0.302594px] leading-[21.1816px] max-w-[252.094px] underline md:text-[15.2873px] md:tracking-[-0.305746px] md:leading-[21.4022px] md:max-w-[509.401px]"
        >
